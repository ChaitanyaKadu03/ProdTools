...
const data = [
  ...
  { id: 3, pageLink: '/a-simple-page', imageLink: asimplepage, text: `Our Note Sharing feature makes it effortless to collaborate with others by securely sharing notes via email or username. Whether it's a document review or sharing ideas, users can grant access to their notes and collaborate in real-time. Shared users can edit, comment, and contribute, making teamwork more dynamic and efficient. It's the perfect solution for teams looking to improve communication and project transparency.` },
]
